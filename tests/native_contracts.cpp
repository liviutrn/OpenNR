...
int main()
{
    ...
    for (const auto* path : {L"D:/opennr-forbidden/new-output", L"X:/opennr-forbidden/new-output"}) {
    ...
    std::cout << "PASS: native guide dimensions, scaling, invalid inputs and storage aliases\n";
}
