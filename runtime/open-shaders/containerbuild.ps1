...
if (-Not (Test-Path -Path "CMakeUserPresets.json")) {
    ...
    (Get-Content -Path "CMakeUserPresets.json") -replace 'F:/MySkyrimModpack/mods/CommunityShaders;F:/SteamLibrary/steamapps/common/SkyrimVR/Data;F:/SteamLibrary/steamapps/common/Skyrim Special Edition/Data', 'C:/open-shaders/build' | Set-Content -Path "CMakeUserPresets.json"
